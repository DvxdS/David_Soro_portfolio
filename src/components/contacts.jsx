  ...
  <section class="mb-32">
    <div class="flex justify-center">
      <div class="text-center md:max-w-xl lg:max-w-3xl">
        <h2 class="mb-12 px-6 text-3xl font-bold text-orange-400">Contact us</h2>
      </div>
    </div>
        ...
        <div class="flex flex-wrap">
          <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
            <div class="flex items-start">
              <div class="shrink-0">
                <div class="inline-block rounded-md bg-orange-50 p-4 text-primary">
              ...
              <div class="ml-6 grow">
                ...
                <p class="text-neutral-500 text-black">
                +250790003964
                </p>
          ...
          <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
            <div class="flex items-start">
              <div class="shrink-0">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="h-6 w-6 text-orange-400">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20 15V5a2 2 0 00-2-2H6a2 2 0 00-2 2v10l8 5 8-5z" />
