    ...
    return(
        <div  className=" p-20 bg-white mt-10 pt-10">
            <div className="flex items-center justify-center w-full">
                <span className="font-bold text-center text-lg mb-10 text-orange-400">
                     My Tech Stack
            ...
            <span className="font-bold text-center  text-orange-400 ml-10 text-xl flex items-center">
                Languages{' '}
                <FaCode className="mr-2 text-orange-400 ml-2"  style={{ width: '30px', height: '30px', marginLeft: '5px' }} />
                </span>
        <div className=' flex'>
            <div className="grid grid-cols-2 gap-4 mt-10 justify-start, ml-10 ">
            ...
            <img src={Reactp} alt="react" className='logo-bounce' />
               ...
               <div className='second-grid flex flex-col items-end '>
        <span className="font-bold text-center  text-orange-400 ml-10 text-xl flex items-center">
                Tools{' '}
                <FaTools className="mr-2 text-orange-400 ml-2"  style={{ width: '30px', height: '30px', 
                marginLeft: '5px' }} />
        </span>
        <div className='flex  '>
            <div className="grid grid-cols-2 gap-4 mt-10 justify-start, ml-10 ">
